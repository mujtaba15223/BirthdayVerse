...
document.querySelectorAll(".cloud").forEach(cloud=>{
    let randomTop = Math.floor(Math.random() * window.innerHeight * 0.6)
...
cakes.addEventListener("click",()=>{
    ...
    button.style.animation = "buttonfade 0.8s ease forwards"
    launchConfetti();
})
...
function createConfettiPiece() {
    ...
    if (
        ...
        piece.style.height = randomBetween(8, 18) + "px";
...
let openGift = document.querySelector("#openGift");

openGift.addEventListener("click", () => {
    document.querySelector("#step4").style.display = "none";
    document.querySelector("#finalSurprise").style.display = "flex";
});

const finalCake = document.querySelector("#finalcake")
